...
let getMovie = () => {
    ...
    let url = `https://www.omdbapi.com/?t=the+batman&y=2022&apikey=5650fb51`;
...
document.getElementById("openPopup12.1").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup12.1");
    var videoIframe = videoPopup.querySelector("iframe");

    // Establece la URL del video de YouTube en el iframe
    videoIframe.src = "https://www.youtube.com/embed/fWQrd6cwJ0A";

    // Muestra el video emergente
    videoPopup.style.display = "block";
});

document.getElementById("closePopup12.1").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup12.1");
    var videoIframe = videoPopup.querySelector("iframe");
...
document.getElementById("openPopup12.2").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup12.2");
    var videoIframe = videoPopup.querySelector("iframe");

    // Establece la URL del video de YouTube en el iframe
    videoIframe.src = "https://www.youtube.com/embed/9FjBS4ElSnU";

    // Muestra el video emergente
    videoPopup.style.display = "block";
});

document.getElementById("closePopup12.2").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup12.2");
    var videoIframe = videoPopup.querySelector("iframe");
