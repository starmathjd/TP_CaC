...
let getMovie = () => {
    ...
    let url = `https://www.omdbapi.com/?t=barbie&y=2023&apikey=5650fb51`;
...
document.getElementById("openPopup3.1").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup3.1");
    var videoIframe = videoPopup.querySelector("iframe");

    // Establece la URL del video de YouTube en el iframe
    videoIframe.src = "https://www.youtube.com/embed/eUP3hlBel5I";

    // Muestra el video emergente
    videoPopup.style.display = "block";
});

document.getElementById("closePopup3.1").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup3.1");
    var videoIframe = videoPopup.querySelector("iframe");
...
document.getElementById("openPopup3.2").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup3.2");
    var videoIframe = videoPopup.querySelector("iframe");

    // Establece la URL del video de YouTube en el iframe
    videoIframe.src = "https://www.youtube.com/embed/qUZ1ZpHp9gs";

    // Muestra el video emergente
    videoPopup.style.display = "block";
});

document.getElementById("closePopup3.2").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup3.2");
    var videoIframe = videoPopup.querySelector("iframe");
