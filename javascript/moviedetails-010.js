...
let getMovie = () => {
    ...
    let url = `https://www.omdbapi.com/?t=Elvis&y=2022&apikey=5650fb51`;
...
document.getElementById("openPopup10.1").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup10.1");
    var videoIframe = videoPopup.querySelector("iframe");

    // Establece la URL del video de YouTube en el iframe
    videoIframe.src = "https://www.youtube.com/embed/JoqmHAr3fu8";

    // Muestra el video emergente
    videoPopup.style.display = "block";
});

document.getElementById("closePopup10.1").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup10.1");
    var videoIframe = videoPopup.querySelector("iframe");
...
document.getElementById("openPopup10.2").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup10.2");
    var videoIframe = videoPopup.querySelector("iframe");

    // Establece la URL del video de YouTube en el iframe
    videoIframe.src = "https://www.youtube.com/embed/BI6Gew01tXE";

    // Muestra el video emergente
    videoPopup.style.display = "block";
});

document.getElementById("closePopup10.2").addEventListener("click", function () {
    var videoPopup = document.getElementById("videoPopup10.2");
    var videoIframe = videoPopup.querySelector("iframe");
